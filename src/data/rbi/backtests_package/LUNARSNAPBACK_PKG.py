...
class LunarSnapback(Strategy):
    ...
    def init(self):
        # Use talib for indicators via self.I() wrapper
    ...
    def next(self):
        ...
        # Manual crossover logic instead of backtesting.lib
        rsi_curr = self.rsi[-1]
        rsi_prev = self.rsi[-2]
        ...
        # Buy logic: RSI crosses BELOW the oversold threshold (Manual Crossunder)
        ...
        # Sell logic: RSI crosses ABOVE the overbought threshold (Manual Crossover)
        elif rsi_curr > self.overbought and rsi_prev <= self.overbought:
...
try:
    ...
    # 🌙 Run Backtest
    # Initial cash: 10,000, Commission: 0.1%
